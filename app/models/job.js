...
Job.reopenClass({
	FIXTURES : [
		...
		{id:9, company:"McGraw-Hill Education", title:"Director of Engineering, Analytics", startDate:"2013-08-01", endDate:null, technologies:"HTML5, CSS3, SVG, JavaScript, JSON, SASS, JQuery, EmberJS, D3js, Foundation, Sublime Text, Photoshop, Illustrator, Dreamweaver, InDesign, Github"}
	]
});
